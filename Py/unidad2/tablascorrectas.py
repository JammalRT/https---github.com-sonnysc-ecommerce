            ...
            #si q no es negada hacer
                ...
                #si p, q, r no eran negadas entonces 
                    ...
                    #si variable res es 0 es falso
                        ...
                        print('Es falso')
#parte del Jose
#inicio parte del Jammal
    #si variable log es igual 2
    elif log == '2':
        #tabla de disyuncion
        print ('disyuncion')
        print ('P Q R \t S')
